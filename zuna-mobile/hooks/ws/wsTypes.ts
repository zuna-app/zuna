...
export interface PresenceUpdatePayload {
  presence: { user_id: string; active: boolean; last_seen: number };
}

export interface PresenceResponsePayload {
  presence: Array<{ user_id: string; active: boolean; last_seen: number }>;
}
...
export interface MessageReadInfoPayload { chat_id: string }
export interface MessageDeleteReceivePayload { id: number }
