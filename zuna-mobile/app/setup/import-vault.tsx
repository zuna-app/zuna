...
import { importVault, importVaultFromBase64 } from '@/lib/vault';
...
export default function ImportVaultScreen() {
  ...
  async function handleBarcode(result: BarcodeScanningResult) {
    if (scannedRef.current || fetchingUrl) return;
    ...
    try {
      ...
      // Response body is raw binary — re-read as base64 via blob
    ...
    return (
      <View style={StyleSheet.absoluteFill}>
        <CameraView
          ...
          onBarcodeScanned={fetchingUrl ? undefined : handleBarcode}
        />
