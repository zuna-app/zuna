...
import { ZunaAvatar } from "@/components/avatar";
...
export function ChatListPanel({
  ...
  const { isLoading: channelsLoading } = useChannelList(server);
  ...
  return (
    <div className="flex w-full md:w-75 shrink-0 flex-col border-r border-border/40 bg-neutral-50 dark:bg-neutral-950/50 h-full">
      ...
      <div className="flex-1 overflow-y-auto pb-2 [scrollbar-width:thin] [scrollbar-color:hsl(var(--border))_transparent]">
        ...
        <div className="px-2">
          ...
          ) : filtered.length === 0 && !search ? null : filtered.length ===
            0 ? (
