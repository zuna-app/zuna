...
func (_q *DeviceQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *DeviceQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *DeviceQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *DeviceQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *DeviceQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *DeviceQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
